...
function formatTrialEnd(trialEndsAt: string): string {
  return new Date(trialEndsAt).toLocaleDateString('en-IN', { day: 'numeric', month: 'short' });
}
...
export default function OnboardingWizard({ trialEndsAt }: Props) {
    ...
    >
      ...
      {trialEndsAt && (
        <Badge variant="amber" className="mb-6">
          14-day free trial started — ends {formatTrialEnd(trialEndsAt)}
        </Badge>
      )}
      ...
      >
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs" style={{ color: 'var(--text-tertiary)' }}>
                      Helps guests find you — skip if you&apos;d rather add it later.
                    </p>
                  </div>
                </div>
        ...
        {step === 'channel' && (
          <>
            ...
            <HelpText label="How to get your Airbnb iCal URL" className="mb-4">
            ...
            <p className="mb-4 text-xs" style={{ color: 'var(--text-tertiary)' }}>
              Don&apos;t use Airbnb yet, or manage bookings manually? Skip this — you can connect it anytime from Settings → Channels.
            </p>
        ...
        {step === 'done' && (
          <div className="text-center">
            ...
            <p className="text-sm mb-8" style={{ color: 'var(--text-secondary)' }}>
              Your dashboard is ready to use. A couple of things are still worth finishing when you get a chance:
            </p>

            <div className="space-y-2 text-left mb-8">
              {[
                'Connect a booking channel (if you skipped it)',
                'Invite a team member, if you have staff',
                'Explore Calendar, Finance, Housekeeping & Maintenance',
              ].map(item => (
            ...
            <p className="text-xs mb-8" style={{ color: 'var(--text-tertiary)' }}>
              You&apos;ll see a checklist for these on your dashboard until they&apos;re done.
            </p>
